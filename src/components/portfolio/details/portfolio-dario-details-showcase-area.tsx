    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{backgroundImage: "url(/assets/img/inner-project/showcase/dario_inner.png)"}}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      ...
                      <h4 className="port-showcase-slider-title tp-char-animation" style={{color: "#b5c9c3"}}>Dario <br/> Photographe</h4>
                    </div>
                </div>
              </div>
          </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right">
                      <p className="tp_title_anim">Dario, photographe talentueux basé à Paris, nous a confié la création de son portfolio en ligne. Notre mission était de concevoir une plateforme élégante qui met en valeur son travail artistique unique, notamment ses portraits saisissants et ses compositions créatives.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right tp_title_anim">
                      <p>Notre principal défi était de créer une expérience visuelle immersive qui reflète l'esthétique unique de Dario tout en assurant une navigation fluide à travers son portfolio. Nous avons développé une interface minimaliste qui met l'accent sur ses photographies, avec des transitions élégantes et une mise en page adaptative qui s'ajuste parfaitement à chaque format d'image.</p>
                  </div>
                </div>
            </div>
          </div>
