    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{backgroundImage: "url(/assets/img/inner-project/showcase/garoa_inner.png)"}}>
          <div className="tp-showcase-details-scroll smooth">
              <a onClick={scrollTo} className="pointer" style={{color: "#ffe5d9"}}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      <span className="port-showcase-slider-subtitle tp_title_anim" style={{color: "#ffe5d9"}}>
                        [ UI, Design Web, Image de marque, Commerce électronique ]
                      </span>
                      <h4 className="port-showcase-slider-title tp-char-animation" style={{color: "#ffe5d9"}}>Garoa <br/> Skincare</h4>
                    </div>
                </div>
              </div>
          </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right">
                      <p className="tp_title_anim">Garoa Skincare nous a approché pour développer une plateforme e-commerce sophistiquée qui met en valeur leur gamme de produits de soins naturels. Notre objectif était de créer une expérience en ligne luxueuse qui reflète la qualité premium de leurs produits tout en facilitant le parcours d'achat des clients.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right tp_title_anim">
                      <p>Le principal défi était de créer une plateforme e-commerce qui allie élégance visuelle et efficacité fonctionnelle. Nous devions mettre en avant la philosophie naturelle et durable de Garoa Skincare tout en offrant une expérience d'achat fluide et sécurisée. Notre solution combine un design épuré avec des fonctionnalités e-commerce avancées, créant ainsi une expérience en ligne qui reflète parfaitement le positionnement haut de gamme de la marque.</p>
                  </div>
                </div>
            </div>
          </div>
