    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{
            backgroundImage:
              "url(/assets/img/inner-project/showcase/astrid_inner.png)",
          }}
        >
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right">
                <p className="tp_title_anim">
                  Astrid Photographie nous a contacté pour créer une présence en
                  ligne qui reflète son style unique et sa vision artistique.
                  Notre mission était de concevoir un site web élégant et
                  minimaliste qui mettrait en valeur son portfolio de
                  photographie tout en communiquant son approche personnelle et
                  authentique.
                </p>
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right tp_title_anim">
                <p>
                  Notre plus grand défi était de créer une expérience numérique
                  qui capture l&apos;essence artistique d&apos;Astrid tout en assurant une
                  navigation intuitive pour ses clients. Nous avons travaillé en
                  étroite collaboration avec elle pour comprendre sa vision et
                  ses besoins spécifiques. Le résultat est un site web qui allie
                  esthétique minimaliste et fonctionnalité, permettant à ses
                  photographies de parler d&apos;elles-mêmes tout en offrant une
