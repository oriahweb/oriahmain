    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{
            backgroundImage:
              "url(/assets/img/inner-project/showcase/refit-inner.png)",
          }}
        >
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right">
                <p className="tp_title_anim">
                  Refit Design d&apos;Intérieur nous a contacté pour créer une
                  présence en ligne sophistiquée qui met en valeur leur
                  expertise en design d&apos;intérieur haut de gamme. Notre mission
                  était de développer une plateforme élégante qui reflète leur
                  vision créative et leur approche innovante du design d&apos;espace,
                  tout en offrant une expérience utilisateur intuitive pour leur
                  clientèle exigeante.
                </p>
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right tp_title_anim">
                <p>
                  Le principal défi était de créer une plateforme numérique qui
                  capture l&apos;essence du design d&apos;intérieur contemporain de Refit
                  tout en mettant en valeur leur portfolio diversifié. Nous
                  devions concevoir une interface qui présente leurs projets de
                  manière immersive et qui communique efficacement leur
                  expertise en matière de transformation d&apos;espaces. Notre
                  solution allie une esthétique minimaliste à des
                  fonctionnalités avancées, offrant une vitrine numérique qui
                  reflète parfaitement leur approche innovante du design
                  d&apos;intérieur.
                </p>
              </div>
            </div>
