    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{backgroundImage: "url(/assets/img/inner-project/showcase/creatiq_inner.png)"}}>
          <div className="tp-showcase-details-scroll smooth">
              <a onClick={scrollTo} className="pointer" style={{color: "#33415c"}}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      <span className="port-showcase-slider-subtitle tp_title_anim" style={{color: "#33415c"}}>
                        [ UI, Design Web, Solutions Numériques ]
                      </span>
                      <h4 className="port-showcase-slider-title tp-char-animation" style={{color: "#33415c"}}>Creatiq <br/> Solutions Web</h4>
                    </div>
                </div>
              </div>
          </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right">
                      <p className="tp_title_anim">Creatiq, une agence de solutions web basée à Paris, nous a confié la refonte complète de leur identité numérique. Notre mission était de créer une plateforme moderne qui reflète leur expertise en développement web et leur approche créative, tout en mettant en valeur leur portfolio de projets innovants.</p>
            ...
            <div className="row">
                ...
                <div className="col-xl-8">
                  <div className="showcase-details-overview-right tp_title_anim">
                      <p>Le défi principal était de créer une plateforme qui démontre l'expertise technique et créative de Creatiq tout en restant intuitive et engageante. Nous avons développé une interface moderne qui met en valeur leurs réalisations et leur savoir-faire en matière de solutions web innovantes. L'accent a été mis sur une expérience utilisateur fluide qui reflète leur approche professionnelle et leur capacité à livrer des projets numériques de haute qualité.</p>
                  </div>
                </div>
            </div>
          </div>
