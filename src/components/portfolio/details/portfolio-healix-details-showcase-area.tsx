    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{
            backgroundImage:
              "url(/assets/img/inner-project/showcase/healix-inner.png)",
          }}
        >
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right">
                <p className="tp_title_anim">
                  Healix Healthcare nous a confié la mission de développer une
                  plateforme médicale innovante qui facilite l&apos;accès aux soins
                  de santé. Notre objectif était de créer une interface
                  intuitive permettant aux patients de gérer leurs rendez-vous
                  médicaux et d&apos;accéder à leurs dossiers de santé en toute
                  sécurité.
                </p>
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right tp_title_anim">
                <p>
                  Le principal défi était de créer une plateforme médicale qui
                  combine accessibilité et sécurité des données. Nous devions
                  développer une interface utilisateur intuitive tout en
                  respectant les normes strictes de confidentialité des données
                  médicales. Notre solution intègre des fonctionnalités avancées
                  de gestion des rendez-vous et des dossiers médicaux, tout en
