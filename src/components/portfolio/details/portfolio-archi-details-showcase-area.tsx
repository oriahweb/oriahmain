    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{
            backgroundImage:
              "url(/assets/img/inner-project/showcase/archi-inner.png)",
          }}
        >
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right">
                <p className="tp_title_anim">
                  Archi Real Estate nous a mandaté pour développer une
                  plateforme immobilière moderne et sophistiquée. Notre objectif
                  était de créer un site web qui présente leur portfolio
                  immobilier haut de gamme de manière élégante tout en offrant
                  une expérience utilisateur intuitive pour les acheteurs
                  potentiels.
                </p>
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right tp_title_anim">
                <p>
                  Le principal défi était de créer une plateforme qui met en
                  valeur les propriétés luxueuses d&apos;Archi Real Estate tout en
                  maintenant une interface utilisateur simple et efficace. Nous
                  avons développé un système de filtrage avancé et une
                  présentation visuelle immersive qui permet aux clients de
                  découvrir chaque propriété en détail. L&apos;accent a été mis sur
                  la création d&apos;une expérience premium qui reflète la qualité
                  des biens immobiliers proposés.
                </p>
              </div>
            </div>
          </div>
