...
export const metadata: Metadata = {
  title: "Oria Consulting - Agence de conseil en stratégie digitale",
  description: "Oria Consulting est une agence de conseil en stratégie digitale qui aide les entreprises à se développer en ligne.",
  icons: {
    icon: '/faviconOriah.ico',
    shortcut: '/faviconOriah.ico',
  },
};
